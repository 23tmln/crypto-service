...
import { ConnectionEventsListener, UnauthenticatedChatConnection, AuthenticatedChatConnection, ChatServiceListener, ProvisioningConnection, ProvisioningConnectionListener } from './net/Chat.js';
...
export declare const REMOTE_CONFIG_KEYS: readonly ["chatRequestConnectionCheckTimeoutMillis", "disableNagleAlgorithm", "useH2ForUnauthChat", "grpc.AccountsAnonymousLookupUsernameHash", "grpc.AccountsAnonymousLookupUsernameLink", "grpc.AccountsAnonymousCheckAccountExistence", "grpc.MessagesAnonymousSendMultiRecipientMessage", "chatRequestConnectionCheckTimeoutMillis.beta", "disableNagleAlgorithm.beta", "useH2ForUnauthChat.beta", "grpc.AccountsAnonymousLookupUsernameHash.beta", "grpc.AccountsAnonymousLookupUsernameLink.beta", "grpc.AccountsAnonymousCheckAccountExistence.beta", "grpc.MessagesAnonymousSendMultiRecipientMessage.beta", "chatPermessageDeflate.prod"];
export declare class Net {
     ...
     * @param options.abortSignal an {@link AbortSignal} that will cancel the connection attempt.
     */
    connectProvisioning(listener: ProvisioningConnectionListener, options?: {
        abortSignal?: AbortSignal;
     ...
     */
    setRemoteConfig(remoteConfig: ReadonlyMap<(typeof REMOTE_CONFIG_KEYS)[number], string>): void;
    /**
     * Updates libsignal's remote configuration settings.
     *
     * The provided configuration map must conform to the following requirements:
     ...
     */
    setRemoteConfig(remoteConfig: ReadonlyMap<(typeof REMOTE_CONFIG_KEYS)[number], string>, buildVariant: BuildVariant): void;
    /**
