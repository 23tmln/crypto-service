...
export interface ProvisioningConnectionListener extends ConnectionEventsListener {
    /**
 ...
 */
export declare class ProvisioningConnection {
    private readonly asyncContext;
    private readonly chatService;
    private readonly chatListener;
    static connect(asyncContext: TokioAsyncContext, connectionManager: ConnectionManager, listener: ProvisioningConnectionListener, options?: {
        abortSignal?: AbortSignal;
     ...
     * end of the fake connection.
     */
    static fakeConnect(asyncContext: TokioAsyncContext, listener: ProvisioningConnectionListener): [ProvisioningConnection, FakeChatRemote];
